...
'    try {',
'        const escaped = text.replace(/\\x27/g, "\\'\\'").substring(0, 400);',
'        cp.execFileSync(\'powershell.exe\', [\'-Command\',',
'            "[System.Speech.Synthesis.SpeechSynthesizer]::new().Speak(\\'" + escaped + "\\\')"',
...
'    }',
'    ',
'    const prompt = userInput.includes('\u8bf7\u7528\u7b80\u6d01') ? userInput : '\u8bf7\u7528\u7b80\u6d01\u81ea\u7136\u7684\u4e2d\u6587\u590d\u56de\u7528\u6237\uff0c\u50cf\u804a\u5929\u5ba4\u7684\u670b\u53cb\uff1a' + userInput;',
'    const replyText = await ollamaGenerate(prompt);',
'    ',
'    if (!replyText) {',
'        await sendReply('\u5c0f\u8111\u8897\u6253\u7762\u7761\u53bb\u4e86 \ud83d\ude34');',
'        log(\'  \u2192 \u6253\u7762\u7761 (\u5168\u90e8\u91cd\u8bd5\u5931\u8d25)\');',
'    } else {',
...
fs.writeFileSync('C:/Users/48856/.openclaw/workspace/matrix-bridge/bot.js', code, 'utf8');
console.log('v7 written: ' + code.length + ' bytes');
